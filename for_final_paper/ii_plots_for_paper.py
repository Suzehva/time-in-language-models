...
#     path+"olmo_rome_b.png", # olmo
#     path+"llama_elmsville_b.png", # 
# ]

image_paths = [  # each set of 2 is a col.
    path+"olmo_response_b.png", # olmo
    path+"llama_response_b.png", #
]
...
# grid.save(path+"ii_location.png")
grid.save(path+"ii_response.png")
